...
$installerType = 'EXE'
$url = 'https://github.com/samhocevar/wincompose/releases/download/v0.9.8/WinCompose-Setup-0.9.8.exe'
$checksum = '0037EA8607CC82D32AF36A3941FF9F4D5608118251CAE1717D6715F210305C2F'
