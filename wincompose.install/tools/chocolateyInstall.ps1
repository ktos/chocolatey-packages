...
$installerType = 'EXE'
$url = 'https://github.com/samhocevar/wincompose/releases/download/v0.8.1/WinCompose-Setup-0.8.1.exe'
$checksum = '760A30CD63CBC88B25BE18300C3AF5B36D164825359178B4C42D0BA3B5DE9AE3'
